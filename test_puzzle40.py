...
# Pubkey comprimida secp256k1 para Puzzle 40
...
print("================================================================")
print(" 🚀 SOLVER TEST — PUZZLE #40 (RTX Local Benchmark)")
print("================================================================")
print(f"Range Alvo : 8000000000:ffffffffff (40 bits)")
print(f"Pubkey     : {pub_compressed}")
print(f"Grid       : 1024,1024 | DP-Bits: 12")
print("----------------------------------------------------------------")
...
print("\n" + "=" * 64)
if found_key:
    print(f"🎉 🎉 🎉 PUZZLE #40 RESOLVIDO COM SUCESSO! 🎉 🎉 🎉")
    ...
    print(f"🎯  Chave Esperada  : e9ae4933d6")
else:
