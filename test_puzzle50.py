...
# Pubkey comprimida secp256k1 para Puzzle 50
...
print("================================================================")
print(" 🚀 SOLVER TEST — PUZZLE #50 (RTX Local Benchmark)")
print("================================================================")
print(f"Range Alvo : 2000000000000:3ffffffffffff (50 bits)")
print(f"Pubkey     : {pub_compressed}")
print(f"Grid       : 1024,1024 | DP-Bits: 16")
print("----------------------------------------------------------------")
...
print("\n" + "=" * 64)
if found_key:
    print(f"🎉 🎉 🎉 PUZZLE #50 RESOLVIDO COM SUCESSO! 🎉 🎉 🎉")
    ...
    print(f"🎯  Chave Esperada  : 22bd43c2e9354")
else:
